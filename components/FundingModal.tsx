...
import { isValidCardNumber } from "@/lib/validation/cardNumber";
          ...
          <div>
            ...
            <input
              {...register("accountNumber", {
                ...
                pattern: {
                  value: fundingType === "card" ? /^\d{13,16}$/ : /^\d+$/,
                  message: fundingType === "card" ? "Card number must be 13-16 digits" : "Invalid account number",
                },
                validate: {
                  validCard: (value) => {
